...
import { X as CloseIcon, User, Mail, Heart, CalendarDays, ShieldCheck } from 'lucide-vue-next'
                    ...
                    <div class="overflow-y-auto px-8 pb-8 space-y-6">
                        ...
                        <div class="flex flex-col items-center gap-4 py-4">
                            ...
                            <div class="text-center">
                                <p class="text-2xl font-bold text-slate-900">{{ user?.nev }}</p>
                                <p class="text-sm text-slate-600 mt-1">FoodR felhasználó</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div
                                ...
                                <p class="text-2xl font-bold text-slate-900">{{ likedCount }}</p>
                                <p class="text-xs text-slate-600 font-medium">Kedvenc recept</p>
                            </div>
                            <div
                                class="rounded-2xl bg-gradient-to-br from-accent-400/40 to-accent-500/40 p-4 text-center shadow-sm">
                                <ShieldCheck class="w-6 h-6 text-brand-600 mx-auto mb-1" />
                                <p class="text-2xl font-bold text-slate-900">Aktív</p>
                                <p class="text-xs text-slate-600 font-medium">Fiók státusz</p>
                            </div>
                        </div>

                        <div class="space-y-3">
                            <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider px-1">Fiók adatok
                            </p>
                            ...
                            <div
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs text-slate-500 font-medium">Felhasználónév</p>
                                    <p class="text-slate-900 font-semibold truncate">{{ user?.nev }}</p>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs text-slate-500 font-medium">Email cím</p>
                                    <p class="text-slate-900 font-semibold truncate">{{ user?.email }}</p>
                                </div>
                            </div>
                        </div>

                        <div class="rounded-2xl bg-brand-700/10 border border-brand-700/20 p-5 space-y-2">
                            <p class="text-sm font-semibold text-brand-700">Hamarosan elérhető</p>
                            <p class="text-xs text-slate-600">Profilkép feltöltése, felhasználónév módosítása, és egyéb
                                személyes beállítások hamarosan elérhetők lesznek.</p>
                        </div>
