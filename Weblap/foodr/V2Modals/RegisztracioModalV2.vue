...
<template>
  <div class="relative w-full h-full">
        <div class="bg-gradient-to-br from-accent-300 via-accent-200 to-accent-300 flex flex-col h-full">
            ...
            <form class="mt-6 space-y-5" @submit.prevent="submit">
              ...
              <div class="transform transition-all duration-300">
                ...
                <FormInput
                  ...
                  placeholder="••••••••"
                  :show-toggle="true"
                  :toggle-state="showPasswordConfirm"
